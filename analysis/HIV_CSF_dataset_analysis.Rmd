...
samples from the same HIV infected patients as two of the CSF samples, as well
as, two CSF samples from uninfected
patients. [@Farhadian] first used two CSF and two bloods samples from the same 
two infected
...
findings. Below, I will describe the percentage of Myeloid2 transcripts
...
The frequency of each cell type in the newly annotated samples can be seen in the table below. Myeloid1, Myeloid3 and Myeloid4 are not or hardly present in the 
...
## Marker gene expression of the predicted cell types {.tabset}
