...
<details> 
<summary>Frequency of each cell type</summary>

```{r}
as.data.frame(table(query$predicted.id)) %>% 
  column_to_rownames("Var1") %>% 
  kable(caption = "Frequency of each cell type in query samples")
...
## Contribution of CSF and blood samples to each cluster after label transfer
