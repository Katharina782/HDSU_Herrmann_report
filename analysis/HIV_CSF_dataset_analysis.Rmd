...
First, the analysis done by [@Farhadian] was reproduced and then a more extended
analysis of the dataset was performed. The microglia-like cell cluster identified
by [@Farhadian] was of particular interest.

The dataset includes three CSF samples from HIV infected patients, two blood 
...
the percentage of Myeloid2 transcripts found by [@Farhadian] could not be 
recapitulated.
...
The results shown by [@Farhadian] are controversial, because when the authors compare
