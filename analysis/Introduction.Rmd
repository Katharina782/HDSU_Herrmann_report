...
HIV in 2020 to be approximately  37.7 million. In the past years the use of
antiretroviral therapy(ART) has increased the life expectancy. One of the most prevalent comborbidities that persist even during ART is HIV-associated 
...
integrases. Due to the availability of combination therapy mortality resulting from HIV infection
...
sequencing (sc-RNAseq) of CSF and blood cells from HIV-infected patients and healthy 
controls identified a microglia-like subtype of myeloid cells in CSF which were 
not present in blood samples from the same patients [@Farhadian]. Expression signatures of these microglia-like cells resembled those of disease-associated 
microglia cells and, therefore, it was proposed that these cells might  be used for diagnosis of HAND from CSF samples [@Farhadian].
...
HIV infection and antiretroviral therapy (ART) with efavirenz (EFZ) [@Ryan]. The
