...
bin. This results in comparible expression levels. The control gene set is 
100-fold larger which means that the average expression of the control gene set 
is like taking an average over 100 randomly drawn gene signature sets. 
