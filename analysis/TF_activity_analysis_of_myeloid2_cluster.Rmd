...
<button onclick="myFunction()">*Click here for details on label transfer*</button>
...
The clusters obatined after transferring the cluster identities from patient 1 to
