...
We tried to cluster the Myeloid2 cells based on their TF activity using
k-means clustering. To do this k-means clustering was performed on 
Myeloid2 cells from patient one (HIV1_CSF) with k=3/4/5. The reason why only 
patient one was used, is that the other two patients might be used for validation of the 
...
Using k = 3, k-means clustering was performed for all 3 patients separately. This
...
appropriate than ANOVA. The Null-Hypothesis of the Kruskal-Wallis-Test is that 
